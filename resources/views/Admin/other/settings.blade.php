...
<!--                                     <div class="form-group row">
                                    ...
                                    <h3>Home Page Settings</h3><hr>
                                    
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label" for="username1">Section 1</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"  name="section_one"  value="{{ $view->section_one }}">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label" for="username1">Section 2</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"  name="section_two"  value="{{ $view->section_two }}">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label" for="username1">Section 3</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control"  name="section_three"  value="{{ $view->section_three }}">
                                        </div>
                                    </div>
