    ...
    <div class="container-fluid  overflow-hidden">
        <div class="row">
            ...
            <div class="pb-5 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="p-3 pb-4 mt-4 bg-white rounded col-md-12 single">
                    <div class="row">
                        <div class="col-xl-7 col-lg-6 col-md-6 col-12 p-4">
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-6 col-12 text-center" style="width: 451px;">

                            <h2 class="fw-bold" style="font-size: 18px;">{{ $viewproduct->product_name }}</h2>
                            ...
                            <div class="mt-3 mb-3 color_select">
                                <div class="row" style="padding-right: 40px;">
                                    <div class="col-md-12">
                                        <p style="margin: 0; font-size: 13px;"><b>Color </b></p>
                                        <div class="g-2 row select_size-container justify-content-center">
                            ...
                            <div class="mt-3 mb-3 color_select">
                                <div class="row" style="padding-right: 40px;">
                                    <div class="col-md-12">
                                        <p class="mb-2" style=" font-size: 13px;"><b>Size </b></p>
                                        <div class="g-2 row select_size-container justify-content-center">
                                            @foreach($product_size as $size)
                                            <div class="col-auto">
                                                <div class="select_size" data-id="{{ $size->id }}">
                                                    <span style="font-size: 9px">{{$size->size}}</span>
                                                    <div class="select_size__check-mark">
                                                        <i class="fa fa-check"></i>
                                                    </div>
                                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div>
                                    <div class="nice-number mx-auto mb-2">
                                ...
                                <div class="mb-2">
                                    @if($viewproduct->stock_status == 1)
                                    <button class="cart w-100" onclick="AddCart('{{ $viewproduct->id }}')" style="font-size: 12px;width: 164px !important;"><i class="fa fa-shopping-basket" aria-hidden="true"></i>&nbsp;&nbsp;Add To Cart</button>
                                    @else
                                    <button class="cart w-100" style="cursor: not-allowed;" style="font-size: 12px;width: 164px !important;"><i class="fa fa-shopping-basket" aria-hidden="true"></i>&nbsp;&nbsp;Add To Cart</button>
                                    @endif
                                </div>
                                ...
                                <div>
                                    ...
                                    <form action="{{ url('/buy_now') }}" method="post">
                                        ...
                                        @csrf
                                        <button class="cart w-100 text-nowrap" type="submit" style="background: #1b99bf;font-size: 12px;width: 164px !important;"><i class="fa fa-shopping-basket me-2"></i> Buy Now</button>
                                    </form>
                                    @else
                                    <a href="{{ url('/user-login') }}" class="cart w-100 text-nowrap text-white d-inline-block" style="background: #4f5556;font-size: 12px;width: 164px !important;">
                ...
                <div class="p-4 mt-4 bg-white col-md-12 details">
