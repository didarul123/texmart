        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-6 col order-4 order-lg-0">
            ...
            <form method="get" action="{{ url('/searchproducts') }}" class="d-flex mt-3 mt-lg-0">
              @csrf
              <select name="category_id" id="" class="border-end-0 rounded-start border-primary search-category" style="max-width: 100px">
          ...
          <div class="col-xl-3 col-lg-3 col-6 order-3">
            <div class="float-end text-dark">
              ...
              <a href="tel:{{$setting->hotline}}" class="text-dark"><i class="fa fa-phone nav-icon text-dark"></i>&nbsp;&nbsp;&nbsp;&nbsp;</a>
